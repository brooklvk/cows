...
(
    ...
    breed character varying COLLATE pg_catalog."default",
    notes text COLLATE pg_catalog."default",
    bulling text COLLATE pg_catalog."default",
    branding_date date,
    mother_cow_id integer,
...
-- INSERT INTO cow(
-- 	cow_id, cow_tag_current, color, phys_description, breed, notes, bulling, branding_date, birth_year)
-- 	VALUES (DEFAULT, 'A1', 'red', 'red white face', 'hereford', 'a very good cow', 'was bulling yesterday', '2023-07-31', '2023');
